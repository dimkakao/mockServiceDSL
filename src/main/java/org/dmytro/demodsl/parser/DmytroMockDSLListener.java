...
public interface DmytroMockDSLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DmytroMockDSLParser#isPresentConditionTypes}.
	 * @param ctx the parse tree
	 */
	void enterIsPresentConditionTypes(DmytroMockDSLParser.IsPresentConditionTypesContext ctx);
	/**
	 * Exit a parse tree produced by {@link DmytroMockDSLParser#isPresentConditionTypes}.
	 * @param ctx the parse tree
	 */
	void exitIsPresentConditionTypes(DmytroMockDSLParser.IsPresentConditionTypesContext ctx);
	/**
