package org.dmytro.demodsl.parser;
...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        MockEndpointRequestDefinitionProcessingService mockEndpointRequestDefinitionProcessingService = new MockEndpointRequestDefinitionProcessingService();
